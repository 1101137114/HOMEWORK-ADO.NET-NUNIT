...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ADODBConnectionString %>" SelectCommand="SELECT * FROM [Student]"></asp:SqlDataSource>
    <div>
