...
<body>
    ...
    <div>
        ...
        <br />
        <asp:GridView ID="gvResult" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="464px" OnSelectedIndexChanged="gvResult_SelectedIndexChanged">
